    ...
    return <div className="lg:col-span-1">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-4 sticky top-4">
            <h2 className="font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                <BookOpen className="h-5 w-5 mr-2 text-blue-600 dark:text-purple-400" />
            ...
            {categories.map(category => (
                <div key={category} className="mb-3">
                    ...
                    <button
                        ...
                        className="flex items-center justify-between w-full p-3 text-left hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
                    >
                            ...
                            {lessons
                                ...
                                .map(lesson => (
                                    <button
                                        ...
                                        className="flex items-center justify-between w-full text-left p-2 text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-purple-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md transition-colors"
                                    >
